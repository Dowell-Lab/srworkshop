...
You can choose either ONE of the fastq files in `/scratch/Shares/public/sread/data_files/day5/fastq/assessment_fastq/` OR do ALL of them with a loop. Either way, edit the scripts you made in your first week and run the following steps on your dataset:
