...
2) Go to the European website with raw data and gather both the metadata file and the download scripts. Go to the ENA website and find your favorite project. FOr the example please use PRJEB32618 (I chose this example because its small) But in the pictures I show other projects I've done.
