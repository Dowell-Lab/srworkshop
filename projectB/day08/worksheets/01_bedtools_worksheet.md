...
- Take a moment to look at the information for these two file types from the UCSC link above, then use head to look at the gene annotation bedfile located at <code>head /scratch/Shares/public/sread2025/cookingShow/day9b/annotation/hg38_refseq_cleaned.sorted.bed</code>. Can you identify all the columns?
